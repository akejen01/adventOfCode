...
def main():
    ...
    for noun in range(0,99):
        for verb in range(0,99):
            inputArray = charArray.copy()
            inputArray[1] = noun
            inputArray[2] = verb
            outputArray = intCodeComputer(inputArray)
            #print("Test: noun=", str(noun) , " verb=",str(verb), " ==> " , str(outputArray[0]))
            if (outputArray[0] == '19690720'):
                finalValue = noun * 100 + verb
                print("Bingo! noun=", str(noun) , " verb=",str(verb), " ==> " , str(outputArray[0]), " ==> ", str(finalValue) )
